...
export function StickyCTA({ onDownloadClick, onTryClick }: StickyCTAProps) {
      ...
      {visible && (
        ...
        >
          ...
          >
            ...
            <span className="font-mohave font-medium text-[13px] uppercase tracking-[0.03em] text-white whitespace-nowrap">
              DOWNLOAD FREE
            </span>
          </button>
