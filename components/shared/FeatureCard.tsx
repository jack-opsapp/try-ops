...
export function FeatureCard({ icon, title, description, forLine, bullets, children }: FeatureCardProps) {
  return (
    <motion.div
      className="bg-ops-card border border-ops-border rounded-ops-card p-8 transition-all duration-300 hover:border-ops-border-emphasis hover:-translate-y-1 h-full"
      {...fadeInUp}
    >
