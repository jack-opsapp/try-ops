...
export function PhasedLabel({
  ...
  return (
    <div className="relative">
      {/* Space reservation */}
      <span className="font-mono font-normal text-ops-caption text-transparent select-none uppercase tracking-wider">
        {text}
      </span>
      ...
      {isAtLeast('labelsTyping') && (
        <span className="absolute inset-0">
          <TypewriterText
            text={text}
            className="font-mono font-normal text-ops-caption text-ops-text-secondary uppercase tracking-wider"
            typingSpeed={25}
