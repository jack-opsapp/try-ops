...
const COPY: Record<Scene, { chapter: number; time: string; title: string; body: string; hint: string }> = {
  ...
  calendar: { chapter: 4, time: 'THURSDAY · ALL TASKS COMPLETE', title: 'The job is complete.', body: 'Your crew finished the work and posted the photo. The update comes to you.', hint: 'Tap the completion notification to open the project.' },
