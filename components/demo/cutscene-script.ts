...
export function cutsceneScript(id: CutsceneId, state: LifecycleState): CutsceneScript {
  ...
  const scripts: Record<CutsceneId, CutsceneScript> = {
    ...
    workday: {
      title: 'Thursday, from start to complete.',
      body: 'Thursday on site. Follow the crew’s progress through their photos and updates.',
      beats: [
        {
          id: 'crew-on-job',
          kind: 'calendar',
          actor: crew,
          actorRole: 'Assigned crew',
          eyebrow: 'THURSDAY · 8:00 AM · WORKDAY',
          title: 'Crew on Cedar Lane',
          body: `Thursday’s resurfacing work begins with ${crew} and the attached site notes.`,
          facts: [
            { label: 'Project', value: SAMPLE.project },
            { label: 'Task', value: SAMPLE.task },
          ],
          duration: 2800,
        },
        {
          ...
          actor: updateAuthor,
          actorRole: 'Crew member',
          eyebrow: 'THURSDAY · 12:18 PM · PROGRESS',
          title: 'Progress photo added',
          body: 'Composite boards are going down while the existing frame, stair structure and railing remain.',
          image: SAMPLE.progressPhoto,
          direction: 'incoming',
          duration: 3700,
        },
        {
          ...
          actor: updateAuthor,
          actorRole: 'Crew member',
          eyebrow: 'THURSDAY · 3:40 PM · COMPLETE',
          title: 'Completion photo and note posted',
          body: SAMPLE.note,
          detail: 'Finished photo attached · Both labor tasks complete',
          image: SAMPLE.afterPhoto,
          direction: 'incoming',
          duration: 4700,
        },
      ],
