...
function reachOperatorActivity(name = 'Pete') { reachProject(); assignInstallationCrew(name); click('See the completed work'); skipScene() }
...
describe('the visitor sample job', () => {
  ...
  it('discards a cancelled crew choice and attributes incoming work only to the selected person', () => {
    ...
    click('Select Nick'); click('Done'); click('See the completed work'); skipScene()
    first.unmount(); render(<DemoExperience />)
